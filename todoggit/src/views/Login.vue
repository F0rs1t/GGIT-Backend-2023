    ...
    <div v-else>
      <form>
        <div class="login-box">
          ...
          <div class="btns">
              <a href="#" class="btn" @click="register">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
...
import { getAuth, signInWithEmailAndPassword, createUserWithEmailAndPassword, 
        onAuthStateChanged, signInWithPopup, GoogleAuthProvider, getAdditionalUserInfo 
        } from "firebase/auth";
import router from '@/router';
import '@fortawesome/fontawesome-free/css/all.css'; // bulma icons
...
.login-box input[type="submit"]::after {
  content: "";
  position: absolute;
  display: block;
  top: -100%;
